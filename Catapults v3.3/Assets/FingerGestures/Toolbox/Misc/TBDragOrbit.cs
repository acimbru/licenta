...
public class TBDragOrbit : MonoBehaviour
{
    ...
    /// </summary>
    bool allowPanning = false;
    bool invertPanningDirections = false;
    float panningSensitivity = 1.0f;
    Transform panningPlane;  // reference transform used to apply the panning translation (using panningPlane.right and panningPlane.up vectors)
    bool smoothPanning = true;
    float smoothPanningSpeed = 8.0f;
    float lastPanTime = 0;
    ...
    void OnEnable()
    {
        FingerGestures.OnTwoFingerDragMove += FingerGestures_OnDragMove;
