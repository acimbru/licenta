...
public class EnergyBarRenderer : EnergyBarBase {
    ...
    public static Texture2D windBar;
...
#region Update
	...
	void WindSetup(){
		switch(direction){
			case 0:growDirection=GrowDirection.LeftToRight;
			       break;
			case 1:growDirection=GrowDirection.LeftToRight;
			       break;
			case 2:growDirection=GrowDirection.RightToLeft;
			       break;
		}
		textureBar=windBar;	
	}
