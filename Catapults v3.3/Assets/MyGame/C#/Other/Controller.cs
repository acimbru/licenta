...
public class Controller : MonoBehaviour
{
   ...
   // public AnimationsState _characterState;
    ...
    void UpdateSmoothedMovementDirection()
    {
        ...
        if (grounded)
        {
            ...
            if (Input.GetKey(KeyCode.LeftShift) | Input.GetKey(KeyCode.RightShift))
            {
                ...
                _characterState = AnimationsState.Running;
            }
            else if (Time.time - trotAfterSeconds > walkTimeStart)
            {
                targetSpeed *= trotSpeed;
                _characterState = AnimationsState.Trotting;
            }
            else
            {
                targetSpeed *= walkSpeed;
                _characterState = AnimationsState.Walking;
            }
    ...
    void DidJump()
    {
        ...
        _characterState = AnimationsState.Jumping;
    }
    ...
    {        
        ...
        if (_animation)
        {
            if (_characterState == AnimationsState.Jumping)
            {
            ...
            else
            {
                ...
                {
                    if (_characterState == AnimationsState.Idle)
                    {
                        _animation.CrossFade(idleAnimation.name);
                    }
                    else if (_characterState == AnimationsState.Running)
                    {
                    ...
                    else if (_characterState == AnimationsState.Trotting)
                    {
                    ...
                    else if (_characterState == AnimationsState.Walking)
                    {
